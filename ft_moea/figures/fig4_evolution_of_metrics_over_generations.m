...
%% 
% PyH5PRA7Qw_fig_convergence_between_few_generations
createfigure(compare_all{1}.tree_size(:,[1,2,3,10,20]), 1-compare_all{1}.acc_data(:,[1,2,3,10,20]), 1-compare_all{1}.acc_mcs(:,[1,2,3,10,20]))
createfigure(compare_all{2}.tree_size(:,[1,2,3,10,20]), 1-compare_all{2}.acc_data(:,[1,2,3,10,20]), 1-compare_all{2}.acc_mcs(:,[1,2,3,10,20]))
% exportgraphics(gcf,'d_sX.png','Resolution',300)
%%
...
% Create figure
figure1 = figure('position',[844   418   240   230],...
    'PaperUnits','inches',...
...
axes1 = axes('Parent',figure1,...
    'Position',[0.2252    0.2345    0.7081    0.7281]);
hold(axes1,'on');

% Create multiple lines using matrix input to plot3
plot31 = plot3(XMatrix1,YMatrix1,ZMatrix1,'Parent',axes1,'Marker','o',...
    'LineStyle','none');
set(plot31(1),'DisplayName','Gen. 1','MarkerFaceColor',[1 0 0],...
    'Color',[1 0 0]);
set(plot31(2),'DisplayName','Gen. 2','MarkerFaceColor',[0 1 0],...
    'Color',[0 1 0]);
set(plot31(3),'DisplayName','Gen. 3','MarkerFaceColor',[0 0 1],...
    'Color',[0 0 1]);
set(plot31(4),'DisplayName','Gen. 10','MarkerFaceColor',[1 0 1],...
    'Color',[1 0 1]);
set(plot31(5),'DisplayName','Gen. 20','MarkerFaceColor',[0 0 0],...
    'Color',[0 0 0]);
